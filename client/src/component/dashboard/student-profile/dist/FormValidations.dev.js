...
var _default = [Yup.object().shape((_Yup$object$shape = {}, _defineProperty(_Yup$object$shape, appNo.name, Yup.string()), _defineProperty(_Yup$object$shape, admDate.name, Yup.date().required("".concat(admDate.errorMessage))), _defineProperty(_Yup$object$shape, studentName.name, Yup.string().required("".concat(studentName.errorMessage))), _defineProperty(_Yup$object$shape, studentClass.name, Yup.string().required("".concat(studentClass.errorMessage))), _defineProperty(_Yup$object$shape, gender.name, Yup.string().required("".concat(gender.errorMessage))), _defineProperty(_Yup$object$shape, dateOfBirth.name, Yup.date().required("".concat(dateOfBirth.errorMessage))), _defineProperty(_Yup$object$shape, category.name, Yup.string().required("".concat(category.errorMessage))), _defineProperty(_Yup$object$shape, subCategory.name, Yup.string()), _defineProperty(_Yup$object$shape, emailId.name, Yup.string().email("".concat(emailId.invalidMessage)).required("".concat(emailId.errorMessage))), _defineProperty(_Yup$object$shape, mobileNumber.name, Yup.string().required("".concat(mobileNumber.errorMessage)).test("len", "".concat(mobileNumber.invalidMessage), function (val) {
  return val && val.length === 10;
})), _defineProperty(_Yup$object$shape, religion.name, Yup.string().required("".concat(religion.errorMessage))), _defineProperty(_Yup$object$shape, documentCompleted.name, Yup.string().required("".concat(documentCompleted.errorMessage))), _defineProperty(_Yup$object$shape, aadhaarNumber.name, Yup.string().required("".concat(aadhaarNumber.errorMessage))), _defineProperty(_Yup$object$shape, vatsalyaYojana.name, Yup.string().required("".concat(vatsalyaYojana.errorMessage))), _defineProperty(_Yup$object$shape, fatherName.name, Yup.string().required("".concat(fatherName.errorMessage))), _defineProperty(_Yup$object$shape, motherName.name, Yup.string().required("".concat(motherName.errorMessage))), _defineProperty(_Yup$object$shape, gaurdianName.name, Yup.string().required("".concat(gaurdianName.errorMessage))), _defineProperty(_Yup$object$shape, gaurdianRelationship.name, Yup.string().required("".concat(gaurdianRelationship.errorMessage))), _defineProperty(_Yup$object$shape, annualIncome.name, Yup.number("".concat(annualIncome.invalidMessage)).required("".concat(annualIncome.errorMessage))), _defineProperty(_Yup$object$shape, gaurdianMobileNumber.name, Yup.string().required("".concat(gaurdianMobileNumber.errorMessage)).test("len", "".concat(gaurdianMobileNumber.invalidMessage), function (val) {
  return val && val.length === 10;
})), _defineProperty(_Yup$object$shape, permanentAddress.name, Yup.string().required("".concat(permanentAddress.errorMessage))), _defineProperty(_Yup$object$shape, state.name, Yup.string().required("".concat(state.errorMessage))), _defineProperty(_Yup$object$shape, gaurdianAddress.name, Yup.string().required("".concat(gaurdianAddress.errorMessage))), _defineProperty(_Yup$object$shape, residanceRegion.name, Yup.string().required("".concat(residanceRegion.errorMessage))), _defineProperty(_Yup$object$shape, durationOfResidance.name, Yup.string().required("".concat(durationOfResidance.errorMessage))), _defineProperty(_Yup$object$shape, residanceOfUK.name, Yup.string().required("".concat(residanceOfUK.errorMessage))), _defineProperty(_Yup$object$shape, instituteRegion.name, Yup.string().required("".concat(instituteRegion.errorMessage))), _defineProperty(_Yup$object$shape, examinationPassed.name, Yup.string().required("".concat(examinationPassed.errorMessage))), _defineProperty(_Yup$object$shape, lastAttended.name, Yup.string().required("".concat(lastAttended.errorMessage))), _defineProperty(_Yup$object$shape, subject1.name, Yup.string().required("".concat(subject1.errorMessage))), _defineProperty(_Yup$object$shape, subject2.name, Yup.string()), _defineProperty(_Yup$object$shape, subject3.name, Yup.string()), _defineProperty(_Yup$object$shape, qualification.name, Yup.array(Yup.object({
